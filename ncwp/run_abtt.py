...
NCWP_mean_pool. ABTT/PCA/ZCA are closed-form (ncwp.common); NCWP uses the
faithful paper trainer (ncwp.ncwp_ref). Comparison of published NCWP against
closed-form anisotropy correction -> seeds 42,43,44. Cached embeddings.
Output: results/table_abtt_baseline.
"""
import argparse
