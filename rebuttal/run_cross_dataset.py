...
via ncwp_ref. New -> seeds 0,1,2. Output: rebuttal_outputs_v2/table_cross_dataset_transfer_{sts,retrieval}.
"""
import argparse
import json
import os
...
PROMPT_CACHE = "/workspace/NCWP/rebuttal_outputs_v2/prompt_cache"
