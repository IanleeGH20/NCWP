...
rebuttal_outputs_v2/prompt_cache. This runner just:
...
from rebuttal.common import MODEL_CONFIGS, load_sts_benchmark, metadata_row, spearman_sts, subset_eval_from_cache
...
def main():
    ...
    for model in args.model:
        rows.extend(run(model, REBUTTAL_DIMS[model], args.seeds, args.eval_split))
