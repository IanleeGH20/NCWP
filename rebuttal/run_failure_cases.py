...
Human-readable examples for the rebuttal. Cached embeddings + ZCA (closed-form),
no NCWP training needed. Output: rebuttal_outputs_v2/mined_positive_failure_cases.{csv,md}.
"""
import argparse
import csv
import json
