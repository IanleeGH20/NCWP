...
embeddings in rebuttal_outputs_v2/prompt_cache (no re-encoding).
...
def main():
    ...
    for model in args.models:
        all_rows.extend(run_model(model, REBUTTAL_DIMS[model], args.seeds, args.eval_split, args.source))
